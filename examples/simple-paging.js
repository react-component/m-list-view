...
var Demo = function (_React$Component) {
  ...
  function Demo(props) {
    ...
    _this._onEndReached = function (event) {
      ...
      setTimeout(function () {
        _this._data = _extends({}, _this._data, _this._genData(++pageIndex));
        _this.setState({
  ...
  _createClass(Demo, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        !this.state.destroy ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_rmc_list_view__["a" /* default */], { ref: 'lv',
