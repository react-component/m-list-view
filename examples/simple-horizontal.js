...
var Demo = function (_React$Component) {
  ...
  function Demo(props) {
    ...
    var ds = new __WEBPACK_IMPORTED_MODULE_3_rmc_list_view__["a" /* default */].DataSource({ rowHasChanged: function rowHasChanged(r1, r2) {
        return r1 !== r2;
      } });
    _this.state = {
  ...
  _createClass(Demo, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('style', { dangerouslySetInnerHTML: {
            __html: '\n          .list-view-section-body {\n            display: flex;\n            align-items: center;\n          }\n          .for-body-demo, .list-view-section-body {\n            height: 100%;\n          }\n        ' }
        }),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_rmc_list_view__["a" /* default */], { horizontal: true,
          style: {
            height: 120,
            width: '90%',
            margin: '10px auto',
          ...
          renderRow: function renderRow(rowData) {
            return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('img', { src: __WEBPACK_IMPORTED_MODULE_4__util__["c" /* THUMB_URLS */][0] }),
